        ...
        <div class="side-menu">
            ...
            <div class="insert-post">
                ...
                <div class="img-post">
                    ...
                    <input type="file" name="file_images" id="image" >
                        <!-- <label for="image">
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-emoji-smile" viewBox="0 0 16 16">
                            ...
                            <!-- <input type="file" name="images" id="image" style="display:none;"> -->
                    <!-- </label> -->
                </div>
            <div>
                </div>
            ...
            <div class="btn-post">
                <button class="submit-post" name='submit' type='submit'>POST</button>
            </div>
    </div>
</form>
